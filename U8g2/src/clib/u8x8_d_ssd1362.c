...
static const uint8_t u8x8_d_ssd1362_256x64_flip1_seq[] = {
    U8X8_START_TRANSFER(), /* enable chip, delay is part of the transfer start */
    U8X8_CA(0xa0, 0xc2),   // Set Remap c2 = 11000010
    U8X8_END_TRANSFER(),   /* disable chip */
    U8X8_END()             /* end of sequence */
};
...
static const uint8_t u8x8_d_ssd1362_256x64_init_seq[] = {
    ...
    U8X8_CA(0x81, 0x7f), // Set contrast
    U8X8_CA(0xa0, 0xc1), // Set Re-map c1 = 11000001
    ...
    U8X8_CA(0xbc, 0x04), // Set pre-charge voltage level, 0..0x1f, 0x1f = 0.51*Vcc
    U8X8_CA(0xbd, 0x00), // Pre-charge voltage capacitor Selection, 0: without, 1: with Vp capacitor
    U8X8_CA(0xbe, 0x05), // Set cOM deselect voltage level, 7 = 0.86*Vcc
